...
function submitForm() {
	$('#saveAuthForm')
			.form(
					'submit',
					{
						url : "/basicinfo/admin/affiliatedTypeManage/saveOrUpdateAffiliatedType.json?type=list",
						ajax : true,
						onSubmit: function(){
																...
																if (r) {
																	$
																			.ajax({
																				type : "POST",
																				dataType : 'html',
																				url : '/basicinfo/admin/affiliatedTypeManage/deleteAffiliatedType.json?type=list&ids='
																						+ ids,
																				success : function(
																						data) {
																					var obj = eval('('
