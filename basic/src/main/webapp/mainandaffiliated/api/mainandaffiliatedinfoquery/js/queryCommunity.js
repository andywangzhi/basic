	...
	$("#search")
			.click(
					function() {
						...
						$
								.ajax({
									url : "/basicinfo/api/mainAndAffiliatedInfomationQuery/queryMainAndAffiliatedInfomation.json?type=community&detail_location_flag=true",
									data : param,
									type : "POST",
									dataType : 'JSON',
									xhrFields : {
	...
	$("#search2")
			.click(
					function() {
						...
						$
								.ajax({
									url : "/basicinfo/api/mainAndAffiliatedInfomationQuery/queryMainAndAffiliatedInfomationCount.json?type=community",
									data : param,
									type : "POST",
									dataType : 'JSON',
									success : function(data) {
