	...
	$("#search")
			.click(
					function() {
						...
						$
								.ajax({
									url : "/basicinfo/api/mainAndAffiliatedInfomationQuery/queryMainAndAffiliatedInfomation.json?type=floor&detail_location_flag=true",
									data : param,
									type : "POST",
									dataType : 'JSON',
									xhrFields : {
	...
	$("#search2")
			.click(
					function() {
						...
						$
								.ajax({
									url : "/basicinfo/api/mainAndAffiliatedInfomationQuery/queryMainAndAffiliatedInfomationCount.json?type=floor",
									data : param,
									type : "POST",
									dataType : 'JSON',
									success : function(data) {
